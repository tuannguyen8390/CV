...
\section{Professional experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart 
      	\resumeBlack{Application of long-read sequencing in bovine research}
        \resumeBlack{Creating efficient, scalable, reproducible pipeline for automated processing of genomics data (Genotyping by sequencing/microarray, Short-read Imputation, GWAS, RNAseq and Long-read structural variant discovery)}
